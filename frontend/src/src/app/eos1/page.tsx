    ...
    <div className="bg-[#111827]">
      ...
      <div className="flex">
        ...
        <div className="flex-1 bg-[#111827] p-4">
          ...
          {/* Game Display Area */}
          <div className="bg-[#111827] rounded-lg mb-4 flex items-center justify-center">
            <iframe 
        ...
        <div className="w-80 bg-[#111827] p-4 space-y-4">
          ...
          <div className="bg-[#111827] rounded-lg p-3">
            ...
            <div className="mb-4">
              ...
              <input
                type="text"
                className="w-full p-2 bg-[#111827] text-white rounded border border-blue-600"
            ...
            <div className="flex gap-2 mb-4">
              <button className="px-3 py-1 bg-[#60A5FA]-700 text-blue-200 rounded hover:bg-blue-600 text-sm">
                Reset
              </button>
              <button className="px-3 py-1 bg-[#60A5FA]-700 text-blue-200 rounded hover:bg-blue-600 text-sm">
                Max
