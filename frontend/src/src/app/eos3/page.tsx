...
export default function EOS3Page() {
  const [activeTab, setActiveTab] = useState('EOS3');
                  ...
                  <div className="betinfo-section">
                    <div className="current-round-info">
                      <div className="round-header">
                        <span className="round-title">Current Round [3257]</span>
                        <span className="countdown">02:15</span>
                      </div>
                      <div className="round-details">
                        EOS3Min3310226871BE2E (3256) Round
                      </div>
