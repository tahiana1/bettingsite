 ...
 * 
 * This component provides a comprehensive betting interface for EOS Min Powerball game.
...
export default function EOSPage() {
   ...
   * @param tabName - The name of the tab clicked (EOS1, EOS2, EOS, etc.)
   * 
   * Behavior:
   * - If clicking a different game tab, navigates to that game's page
   * - If clicking current tab (EOS), resets the interface state
   */
