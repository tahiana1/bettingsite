...
const PartnerPage: React.FC = () => {
  ...
  const [selectedLosingRollingTab, setSelectedLosingRollingTab] = useState<string>("losingSetting(Lotus/MGM)");
          ...
          >
            ...
            >
              <Space direction="vertical" className="gap-4 w-full">
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedLosingRollingTab === "losingSetting(Lotus/MGM)" && <LosingSettingPage data={{ currentUser }}/>}
                </div>
              </Space>
            </Card>
          </Modal>
