...
/**
 * EOS2Page Component - Powerball Betting Interface
 * 
 * This component provides a comprehensive betting interface for EOS2 Min Powerball game.
...
export default function EOS2Page() {
  ...
  const [activeTab, setActiveTab] = useState('EOS2'); // Currently selected game tab
   ...
   * - If clicking current tab (EOS2), resets the interface state
   */
   ...
   * @param category - The category of the betting option (powerball/normalball)
   */
              ...
              <div className="bet-sidebar">
                    <div className="current-round-info">
                      ...
                      <div className="round-details">
                        EOS2Min3310226871BE2E (1256) Round
                      </div>
