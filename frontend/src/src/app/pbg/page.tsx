 ...
 * 
 * This component provides a comprehensive betting interface for PBG Min Powerball game.
...
export default function PBGPage() {
  ...
  const [activeTab, setActiveTab] = useState('PBG'); // Currently selected game tab
   ...
   * @param tabName - The name of the tab clicked (EOS1, EOS2, PBG, etc.)
   * 
   * Behavior:
   * - If clicking a different game tab, navigates to that game's page
   * - If clicking current tab (PBG), resets the interface state
   */
