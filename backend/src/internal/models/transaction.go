...
type Transaction struct {
	...
	Type   string  `json:"type" gorm:"size:200"`   // "deposit" or "withdrawal"
	...
	Explation     string  `json:"explation" gorm:"size:100"` // User's explation
	...
	Status   string `json:"status" gorm:"size:200"`   // e.g., "pending", "completed", "failed"
	Shortcut string `json:"shortcut" gorm:"size:200"` // e.g., "pending", "completed", "failed"
