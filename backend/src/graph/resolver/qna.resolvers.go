...
/*
	func (r *qnaResolver) DeletedAt(ctx context.Context, obj *models.Qna) (*gorm.DeletedAt, error) {
	panic(fmt.Errorf("not implemented: DeletedAt - deletedAt"))
}
func (r *Resolver) Qna() generated.QnaResolver { return &qnaResolver{r} }
type qnaResolver struct{ *Resolver }
*/
